...
public class FragmentContainerHelper {
    ...
    public FragmentContainerHelper(Indicator magicIndicator) {
    ...
    public void attachMagicIndicator(Indicator magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (Indicator magicIndicator : mMagicIndicators) {
